...
class SoloColorMedida extends Component
{

    public $medida, $colores, $color_id = 5, $cantidad, $abierto = false;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.producto.solo-color-medida', compact('medida_colores'));
    }
}
