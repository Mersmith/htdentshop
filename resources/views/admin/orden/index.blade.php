<x-admin-layout>
    ...
    <div class="container py-12">
        ...
        <section class="grid grid-cols-4 gap-6 text-white">
            ...
            <a href="{{ route('admin.ordenes.index') . '?estado=2' }}"
            ...
            <a href="{{ route('admin.ordenes.index') . '?estado=3' }}"
            ...
            <a href="{{ route('admin.ordenes.index') . '?estado=4' }}"
            ...
            <a href="{{ route('admin.ordenes.index') . '?estado=5' }}"
            ...
            <section class="bg-white shadow-lg rounded-lg px-12 py-8 mt-12 text-gray-700">
                ...
                <ul>
                    @foreach ($ordenes as $orden)
                        <li>
                            <a href="{{ route('admin.ordenes.mostrar', $orden) }}"
