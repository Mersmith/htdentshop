<div class="container py-12">
    ...
    <x-jet-form-section submit="crearDepartamento" class="mb-6">
                    ...
                    @foreach ($departamentos as $departamento)
                        <tr>
                            <td class="py-2">
                                ...
                                <a href="{{ route('admin.departamentos.mostrar', $departamento) }}"
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    <a class="pr-2 hover:text-blue-600 cursor-pointer"
                                        wire:click="editarModal({{ $departamento }})">Editar</a>
                                    <a class="pl-2 hover:text-red-600 cursor-pointer"
                                        wire:click="$emit('eliminarDepartamentoModal', {{ $departamento->id }})">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    <x-jet-dialog-modal wire:model="editarFormulario.abierto">
        ...
        <x-slot name="footer">
            <x-jet-danger-button wire:click="actualizarDepartamento" wire:loading.attr="disabled"
                wire:target="actualizarDepartamento">
                Actualizar
            </x-jet-danger-button>
        </x-slot>
            ...
            Livewire.on('eliminarDepartamentoModal', departamentoId => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.departamento.departamento-componente', 'eliminarDepartamento',
                            departamentoId)
