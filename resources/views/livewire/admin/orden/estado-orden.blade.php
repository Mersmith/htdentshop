<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-lg shadow-lg px-12 py-8 mb-6 flex items-center">
        ...
        <div class="relative">
            <div class="{{ ($orden->estado >= 2 && $orden->estado != 5) ? 'bg-blue-400' : 'bg-gray-400' }}  rounded-full h-12 w-12 flex items-center justify-center">
        ...
        <div class="{{ ($orden->estado >= 3 && $orden->estado != 5) ? 'bg-blue-400' : 'bg-gray-400' }} h-1 flex-1 mx-2"></div>

        <div class="relative">
            <div class="{{ ($orden->estado >= 3 && $orden->estado != 5) ? 'bg-blue-400' : 'bg-gray-400' }} rounded-full h-12 w-12 flex items-center justify-center">
        ...
        <div class="{{ ($orden->estado >= 4 && $orden->estado != 5) ? 'bg-blue-400' : 'bg-gray-400' }} h-1 flex-1 mx-2"></div>

        <div class="relative">
            <div class="{{ ($orden->estado >= 4 && $orden->estado != 5) ? 'bg-blue-400' : 'bg-gray-400' }} rounded-full h-12 w-12 flex items-center justify-center">
                <i class="fas fa-check text-white"></i>
            </div>
